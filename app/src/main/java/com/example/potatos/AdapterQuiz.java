...
public class AdapterQuiz extends BaseAdapter {
    ...
    AdapterQuiz(Context c, String[] quizNames) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = mInflater.inflate(R.layout.quiz_listview_detail, null);
        TextView quizNameTextView = v.findViewById(R.id.quizNameTextView);
